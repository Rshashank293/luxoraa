...
export const getChatbotResponse = async (userMessage: string, history: any[]) => {
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        systemInstruction: "You are Lumina Concierge, a luxury e-commerce assistant. Help with orders, styling, and sizing."
      }
    });
    return response.text || "I'm processing your request. How else can I assist you?";
  } catch (e) {
    return "I'm processing your request. How else can I assist you with your Lumina experience?";
  }
};