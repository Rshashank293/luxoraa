            ...
            <section className="animate-in fade-in slide-in-from-top-4 duration-1000">
               <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-3">
                    <div className="p-3 bg-indigo-100 text-indigo-600 rounded-2xl"><Sparkles size={24} /></div>
                    <div>
                      <h2 className="text-2xl font-black text-slate-900">Recommended For You</h2>
                      <p className="text-xs text-slate-400 font-bold uppercase tracking-widest">Neural Curation</p>
                    </div>
                  </div>
               </div>
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                {filteredProducts.length === 0 && (
                  <div className="col-span-full py-20 text-center">
                    <p className="text-slate-400 font-bold italic">No matches found in the Luxoraa matrix.</p>
                  </div>
                )}
             </div>
          </section>
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
               <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Luxoraa Credits</p>
    ...
    <div className="max-w-4xl mx-auto py-12 sm:py-20 px-4">
      <div className="flex items-center gap-4 mb-12">
        ...
        <div>
          ...
          <p className="text-slate-500 font-medium">Track and manage your Luxoraa orders</p>
        </div>
      </div>
      ...
      <footer className="bg-slate-900 text-white pt-24 sm:pt-32 pb-10 mt-32">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 sm:gap-20">
          <div className="sm:col-span-2">
            <h2 className="text-3xl sm:text-4xl font-black italic tracking-tighter mb-8 text-indigo-400">LUXORAA GLOBAL</h2>
